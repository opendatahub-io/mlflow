...
def test_generate_all_demos_propagates_workspace_to_child_threads():
    ...
    The server middleware sets the workspace via a ContextVar which is invisible
    to new threads.  generate_all_demos wraps execution in WorkspaceContext so
    the MLFLOW_WORKSPACE env var is set as a fallback for child threads.
    """
