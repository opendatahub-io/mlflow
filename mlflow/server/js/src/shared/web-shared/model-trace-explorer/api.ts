...
export const deleteAssessment = ({ traceId, assessmentId }: { traceId: string; assessmentId: string }) =>
  fetchAPI(`/ajax-api/3.0/mlflow/traces/${traceId}/assessments/${assessmentId}`, { method: 'DELETE' });
...
export const createAssessment = ({
  ...
  fetchAPI(`/ajax-api/3.0/mlflow/traces/${payload.assessment.trace_id}/assessments`, { method: 'POST', body: payload });

export const fetchTraceInfoV3 = ({ traceId }: { traceId: string }) =>
  fetchAPI(`/ajax-api/3.0/mlflow/traces/${traceId}`, { method: 'GET' });
...
export const updateAssessment = ({
  ...
  fetchAPI(`/ajax-api/3.0/mlflow/traces/${traceId}/assessments/${assessmentId}`, { method: 'PATCH', body: payload });
