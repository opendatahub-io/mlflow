...
export const createAssessment = ({
  ...
  fetchAPI(getAjaxUrl(`ajax-api/3.0/mlflow/traces/${payload.assessment.trace_id}/assessments`), { method: 'POST', body: payload });
...
export const updateAssessment = ({
  ...
  fetchAPI(getAjaxUrl(`ajax-api/3.0/mlflow/traces/${traceId}/assessments/${assessmentId}`), { method: 'PATCH', body: payload });
