...
async def export_traces(
    ...
    with _workspace_request_context(request):
...
@contextmanager
def _workspace_request_context(request: Request):
    ...
    try:
        ...
        workspace_name = request.headers.get(WORKSPACE_HEADER_NAME)
        workspace_name = workspace_name.strip() if workspace_name else None
        ...
        if workspace_name:
            ...
            if workspace is None:
                raise MlflowException(
                    ...
                    "header or configure a default workspace.",
