...
class CreatePresignedDownloadUrl(_message.Message):
    __slots__ = ("run_id", "path", "expiration")
    class Response(_message.Message):
        __slots__ = ("presigned_url", "headers", "file_size")
        class HeadersEntry(_message.Message):
            __slots__ = ("key", "value")
            KEY_FIELD_NUMBER: _ClassVar[int]
            VALUE_FIELD_NUMBER: _ClassVar[int]
        ...
        headers: _containers.ScalarMap[str, str]
        file_size: int
        def __init__(self, presigned_url: _Optional[str] = ..., headers: _Optional[_Mapping[str, str]] = ..., file_size: _Optional[int] = ...) -> None: ...
    RUN_ID_FIELD_NUMBER: _ClassVar[int]
    PATH_FIELD_NUMBER: _ClassVar[int]
    EXPIRATION_FIELD_NUMBER: _ClassVar[int]
    run_id: str
...
class BatchGetTraces(_message.Message):
    __slots__ = ("trace_ids", "allowed_experiment_ids")
    class Response(_message.Message):
        __slots__ = ("traces",)
    ...
    ALLOWED_EXPERIMENT_IDS_FIELD_NUMBER: _ClassVar[int]
    trace_ids: _containers.RepeatedScalarFieldContainer[str]
    allowed_experiment_ids: _containers.RepeatedScalarFieldContainer[str]
    def __init__(self, trace_ids: _Optional[_Iterable[str]] = ..., allowed_experiment_ids: _Optional[_Iterable[str]] = ...) -> None: ...
...
class ListScorers(_message.Message):
    __slots__ = ("experiment_id", "allowed_experiment_ids")
    class Response(_message.Message):
        __slots__ = ("scorers",)
    ...
    experiment_id: str
    allowed_experiment_ids: _containers.RepeatedScalarFieldContainer[str]
    def __init__(self, experiment_id: _Optional[str] = ..., allowed_experiment_ids: _Optional[_Iterable[str]] = ...) -> None: ...
