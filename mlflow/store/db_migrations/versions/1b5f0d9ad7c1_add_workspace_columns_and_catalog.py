        ...
        for fk in inspector.get_foreign_keys(table):
            if fk.get("referred_table") == referred_table:
                ...
                if not name and dialect_name == "sqlite":
                    ...
                    if not name:
                        # SQLite may leave the constraint unnamed and we have no reliable alias. Let
                        # the subsequent batch recreation handle it. This matches prior migrations
                        # and has been exercised in downgrade/upgrade roundtrips.
                        continue
