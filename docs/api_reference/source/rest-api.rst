...
|       Field Name       |          Type          |                                                                    Description                                                                     |
+========================+========================+====================================================================================================================================================+
| experiment_id          | ``STRING``             | A single experiment ID. Kept for backward compatibility; prefer ``allowed_experiment_ids`` for multi-experiment queries.                           |
+------------------------+------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------+
| allowed_experiment_ids | An array of ``STRING`` | Optional list of experiment IDs the caller is authorized to access. When provided, only scorers from these experiments are returned. Auth plugins  |
|                        |                        | inject the caller's authorized experiment set here so the storage layer never loads unauthorized scorers.                                          |
+------------------------+------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------+
...
+------------------------+------------------------+-----------------------------------------------------------------------------------------------------------------------------+
| allowed_experiment_ids | An array of ``STRING`` | Optional list of experiment IDs to scope the query. When provided, only traces belonging to these experiments are returned. |
+------------------------+------------------------+-----------------------------------------------------------------------------------------------------------------------------+
...
+------------------------+------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------+
| allowed_experiment_ids | An array of ``STRING`` | Optional list of experiment IDs to scope the query. When provided, only traces belonging to these experiments are returned. This allows auth       |
|                        |                        | plugins to inject the caller's authorized experiment set so the storage layer never loads unauthorized traces.                                     |
+------------------------+------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------+
