...
Workspace permissions apply to **all resource types** (experiments, registered models, prompts) within a workspace. When a user has a workspace permission, it grants access to all resources in that workspace.
